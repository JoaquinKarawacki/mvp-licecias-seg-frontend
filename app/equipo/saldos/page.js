...
export default function PaginaSaldosEquipo() {
  ...
  // Filtro de la vista (no toca el backend, filtra lo ya traído)
  const [busqueda, setBusqueda] = useState("");

  function cargar() {
    setCargando(true);
    setError("");
    pedirApi(`/saldos/equipo?anio=${anio}`)
  ...
  // Aplicamos el filtro de búsqueda sobre los datos traídos
